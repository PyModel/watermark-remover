...
AssetKind = Literal["text", "image", "container"]

_IMAGE_EXTENSIONS = frozenset({".png", ".jpg", ".jpeg", ".heic", ".heif", ".avif"})
...
_ASSET_KINDS: tuple[AssetKind, ...] = ("text", "image", "container")
...
def classify_asset(path: Path, *, forced_kind: str = "auto") -> AssetKind:
    ...
    if detect_image_format(prefix) in ("png", "jpeg", "heif", "avif"):
        return "image"
